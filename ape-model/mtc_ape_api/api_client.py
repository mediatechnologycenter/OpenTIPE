...
class APEClient(TranslationClient):

    def translate(self, translation: MTOutputTranslation, access_token: str = None) -> Tuple[requests.Response, APEOutputTranslation]:
        """
